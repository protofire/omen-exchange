        ...
        <ContentWrapper>
          ...
          <TextfieldCustomPlaceholder
            ...
            onClickMaxButton={() => {
              ...
              setAmountToDisplay(bigNumberToString(wallet, decimals, 5))
            }}
              ...
              <ExchangeDataItem style={{ marginTop: '12px' }}>
                ...
                <span>
                  {exchangeType === ExchangeType.withdraw && currencySelected !== 'dai'
                    ? `${formatBigNumber(displayFundAmount.div(1000), decimals, decimals)} ${symbol}`
                    : `0.00 ${symbol}`}
                </span>
              </ExchangeDataItem>
              <Divider />
              <ExchangeDataItem>
                ...
                <span>
                  {currencySelected !== 'dai' && exchangeType === ExchangeType.withdraw
                    ...
                    : `${formatBigNumber(displayFundAmount, decimals, decimals)} ${symbol}`}
                </span>
              </ExchangeDataItem>
            </>
          )}
