...
const FundingAndFeeStep: React.FC<Props> = (props: Props) => {
  ...
  const onClickMaxButton = async () => {
    ...
    const formatted = bigNumberToString(collateralBalance, userInputCollateral.decimals, 5)
        ...
        <GridTransactionDetailsWrapper noMarginTop={true}>
          ...
          <div>
            <TransactionDetailsCard>
              ...
              <TransactionDetailsRow
                title={'Pool Tokens'}
                value={formatBigNumber(funding, userInputCollateral.decimals, userInputCollateral.decimals)}
              />
            </TransactionDetailsCard>
          </div>
