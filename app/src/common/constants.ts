...
export const GRAPH_RINKEBY_HTTP = 'https://api.thegraph.com/subgraphs/name/mi-lan/omen-rinkeby-fpmm-update'
export const GRAPH_RINKEBY_WS = 'wss://api.thegraph.com/subgraphs/name/mi-lan/omen-rinkeby-fpmm-update'
