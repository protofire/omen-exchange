...
export const GRAPH_RINKEBY_HTTP = 'https://api.thegraph.com/subgraphs/name/kadenzipfel/omen-rinkeby-two' // TODO: change back 'https://api.thegraph.com/subgraphs/name/protofire/omen-rinkeby'
export const GRAPH_RINKEBY_WS = 'wss://api.thegraph.com/subgraphs/name/protofire/omen-rinkeby-two'
