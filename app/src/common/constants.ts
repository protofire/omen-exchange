...
export const GRAPH_RINKEBY_WS = 'wss://api.thegraph.com/subgraphs/name/kadenzipfel/omen-rinkeby' // TODO: change back 'wss://api.thegraph.com/subgraphs/name/protofire/omen-rinkeby'
