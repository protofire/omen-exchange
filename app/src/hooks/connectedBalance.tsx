...
export const ConnectedBalance: React.FC<Props> = (props: Props) => {
  ...
  const value = {
    ...
    daiBalance,
    formattedDaiBalance: formatBigNumber(daiBalance, STANDARD_DECIMALS, STANDARD_DECIMALS),
    xDaiBalance,
    formattedxDaiBalance: formatBigNumber(xDaiBalance, nativeAsset.decimals, 2),
    fetchBalances,
    formattedOmenBalance: formatBigNumber(omenBalance, STANDARD_DECIMALS, STANDARD_DECIMALS),
    omenBalance,
    xOmenBalance,
